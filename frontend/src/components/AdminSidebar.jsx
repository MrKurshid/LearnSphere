...
const AdminSidebar = ({ collapsed, setCollapsed, mobileOpen, setMobileOpen }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 bottom-0 left-0 z-50 bg-slate-900 text-white transition-all duration-300 border-r border-slate-800 flex flex-col justify-between ${
